...
void mpn_toom42_mul (mp_ptr c, mp_srcptr a, mp_size_t an,mp_srcptr b, mp_size_t bn, mp_ptr t);
void mpn_toom32_mul (mp_ptr c, mp_srcptr a, mp_size_t an,mp_srcptr b, mp_size_t bn, mp_ptr t);
void mpn_toom3_sqr_n (mp_ptr c, mp_srcptr a, mp_size_t n, mp_ptr t);
void mpn_toom4_sqr_n (mp_ptr rp, mp_srcptr up, mp_size_t n);
void mpn_toom8_sqr_n  (mp_ptr pp, mp_srcptr ap, mp_size_t an);
void mpn_toom3_interpolate (mp_ptr c, mp_ptr v1, mp_ptr v2, mp_ptr vm1,mp_ptr vinf, mp_size_t k, mp_size_t rr2, int sa,mp_limb_t vinf0, mp_ptr ws);
...
void mpn_toom_couple_handling(mp_ptr pp, mp_size_t n, mp_ptr np,int nsign, mp_size_t off, int ps, int ns);
void mpn_kara_sqr_n(mp_ptr rp, mp_srcptr xp, mp_size_t n, mp_ptr tp);
void mpn_invert (mp_ptr xp, mp_srcptr ap, mp_size_t n);
...
void mpn_sqr_basecase (mp_ptr rp, mp_srcptr up, mp_size_t n);
...
mp_limb_t mpn_dc_div_qr(mp_ptr qp,mp_ptr np, mp_size_t nn,mp_srcptr dp, mp_size_t dn,mp_limb_t dinv);
